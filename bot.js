...
exports.start = function(SETUP) {
    ...
    const UpdateEmbed = function() {
        ...
        let embed = new Discord.RichEmbed()
            ...
            .setAuthor("MemoryHogwartsRP", "https://cdn.discordapp.com/attachments/580680574369398794/582249284825776148/logo_vinity_end.png")
            .setColor(0x2894C2)
            .setFooter(TICK_N % 2 === 0 ? '⚪ Memory Hogwarts RP' : '⚫ Memory Hogwarts RP')
            .setTimestamp(new Date())
            .setDescription('\n\u200b\nGMOD HOGWARTS RP TOPLULUĞU\n\u200b\n')
        if (STATUS !== undefined) {
    ...
    bot.on('ready', () => {
        log(LOG_LEVELS.INFO, 'Başlatıldı...');
        // bot.user.setGame('Roofstad', 'https://www.twitch.tv/RoqueTV');
        bot.user.setActivity('MemoryHogwartsRP', { 'url': '', 'type': 'PLAYING' });
